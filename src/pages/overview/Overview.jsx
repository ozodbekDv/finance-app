    ...
    <div className={style.overview}>
      ...
      <div className={style["overview-top"]}>
        <div>
          ...
          <h6>${data && data.balance[0].current}</h6>
        </div>
        <div>
          <span>Income</span>
          <h6>${data && data.balance[0].income}</h6>
        </div>
        <div>
          <span>Expenses</span>
          <h6>${data && data.balance[0].expenses}</h6>
        </div>
      </div>
      <div className={style["overview-bottom"]}>
        <div className={style["overview-bottom_wrappers"]}>
          <div className={style["overview-pots"]}>
            <div className={style["overview-section-top"]}>
              <h5>Pots</h5>
              <Link to="/pots">
                See Details <img src="../images/icon-caret-right.svg" alt="" />
              </Link>
            </div>
            <div className={style["overview-pots-bottom"]}>
              <div className={style["overview-pots-bottom-left"]}>
                <svg
                  fill="none"
                  height="22"
                  viewBox="0 0 18 22"
                ...
                <span className={style.wrapper}>
                  <span className={style.caption}>Total Saved</span>
                  <span className={style["overview-pots-bottom_title"]}>
                    $850
                  </span>
                </span>
              </div>
              <ul className={style["overview-pots-bottom_list"]}>
                {data &&
                  data.pots.slice(0, 4).map((item) => {
                    return (
                      <li
                        key={item.id}
                        className={style["overview-pots-bottom_list-item"]}
                      >
                        <span
                          style={{
                          ...
                          className={
                            style["overview-pots-bottom_list-item_shape"]
                          }
                        ></span>
                        <div>
                          <span>{item.name}</span>
          ...
          <div className={style["overview-transactions"]}>
            <div className={style["overview-section-top"]}>
              <h5>Transactions</h5>
              <Link to="/transactions">
                View All <img src="../images/icon-caret-right.svg" alt="" />
              </Link>
            </div>
            <ul className={style["overview-transactions-list"]}>
              {data &&
                data.transactions.slice(0, 5).map((item) => {
                  ...
                  return (
                    <li key={item.id} className={style["overview-transaction"]}>
                      <div className={style["overview-transaction-user"]}>
                        <img src={item.avatar} alt={item.name + "avatar"} />
                        <h2>{item.name}</h2>
                      </div>
                      <div className={style["overview-transaction-captions"]}>
                        <h6
        ...
        <div className={style["overview-bottom_wrappers"]}>
          <div className={style["overview-budgets"]}>
            <div className={style["overview-section-top"]}>
              <h5>Budgets</h5>
              <Link to="/budgets">
                View All <img src="../images/icon-caret-right.svg" alt="" />
          ...
          <div className={style["overview-recurring"]}>
            <div className={style["overview-section-top"]}>
              <h5>Recurring Bills</h5>
              <Link to="/budgets">
                See Details <img src="../images/icon-caret-right.svg" alt="" />
              </Link>
            </div>
            <ul className={style["overview-recurring__list"]}>
              <li
                className={style["overview-recurring__list-item"]}
                style={{
                  borderColor: "#277C78",
                }}
              >
